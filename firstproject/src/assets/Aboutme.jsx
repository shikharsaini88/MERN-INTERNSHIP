...
<section id="About" className=" bg-black text-white pt-10 pb-10 border-b-2">
 ...
 <div className="   justify-center  w-190 h-80  shadow-2xl transition-all shadow-black p-4  hover:bg-red-400 text-white">
