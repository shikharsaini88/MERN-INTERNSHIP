...
export default function Contactsearch() {
  ...
  return (
   ...
   <input onChange={(e)=> setNumber(e.target.value)} type='tel' value={number} placeholder='number' className='w-full p-2 border border-gray-300 rounded-lg mb-2' id='numberid'/>
