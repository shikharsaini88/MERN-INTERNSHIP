 export function Contactus(){
  return(<>
  <section id="contact" className=" h-130 bg-[url(aes.jpg)] bg-no-repeat bg-cover border-t-5">
 ...
 <div className="flex justify-center items-center">
    ...
    <div className=" h-96 w-95 shadow-xl shadow-gray-700 rounded-2xl  p-15 bg-none text-white hover:shadow-blue-400 " >
        ...
        <input type="text" placeholder="Enter your Name" className="flex font-bold bg-none text-black mb-1 mt-2 rounded-2xl hover:bg-amber-50"/>
        <input type="email" placeholder="Enter your email" className="flex font-bold bg-none text-black rounded-2xl hover:bg-amber-50"/>
